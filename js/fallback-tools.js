...
const FALLBACK_TOOLS = [
  ...
  },
  {
    ...
    description: {
      ko: "선착순 예매 대기열. 브라우저 시뮬 + 별도 Redis 백엔드(ticket-queue-api, 1천 명 규모부터). 라이브 연결: /ticket-queue/?api=http://서버:8787",
      en: "FCFS ticketing wait-queue. Browser sim plus a real Redis backend (ticket-queue-api, starting ~1k waiters). Live: /ticket-queue/?api=http://host:8787",
    },
    tags: {
      ko: ["웹", "학습", "아키텍처"],
